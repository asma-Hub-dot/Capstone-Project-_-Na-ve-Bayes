...
import pandas as pd  # Library used to create tables (dataframes)
...
print("\nComparison Table:")
print(results)  # Display the table in a clean format

from sklearn.metrics import confusion_matrix  # Used to evaluate model performance in detail
import matplotlib.pyplot as plt               # Used to create visualizations (plots)
